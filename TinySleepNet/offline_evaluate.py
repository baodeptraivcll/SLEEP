...
def main():
    ...
    splits = get_kfold_splits(args.data_dir, k=args.k_folds, random_state=42)
    ...
    for fold in range(args.k_folds):
        ...
        if not os.path.exists(model_path):
            print(f"⚠️ Warning: {model_path} not found. Skipping fold {fold+1}.")
            continue
        ...
        val_dataset = SleepEDFDataset(args.data_dir, val_idx)
    ...
    if len(all_acc) > 0:
        ...
        print("\n❌ No models evaluated. Check your --model_dir.")
