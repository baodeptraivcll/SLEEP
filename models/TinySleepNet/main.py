...
from dataset import get_kfold_splits, check_no_subject_leakage, extract_subject_id, SleepEDFDataset
...
def main():
    ...
    parser.add_argument('--architecture', type=str, default='TinySleepNet', help='Architecture name')
