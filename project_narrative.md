...
- **Bắt buộc xài WandB (Weights & Biases):** Mọi quá trình Train của 4 người phải được log lên hệ thống WandB để minh chứng thời gian thực hiện trong học kỳ. (Sẽ update code `train.py` để tự động đẩy log lên).
